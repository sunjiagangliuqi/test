...
args = {
    "project_id": "liuqi-test-0215094101",
}

dag = DAG(
    "liuqi-test-0215094101",
    default_args=args,
...
op_bb889c69_b23a_484e_8fb3_e69309f38a98 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "liuqi-test-{{ ts_nodash }}",
    },
    volumes=[],
    volume_mounts=[],
    secrets=[],
